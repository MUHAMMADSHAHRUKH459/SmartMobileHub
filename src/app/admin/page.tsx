  ...
  return (
    <div className="min-h-screen bg-black flex items-center justify-center p-4 sm:p-6">
      ...
      <div className="absolute inset-0">
        <div className="absolute top-1/4 left-1/4 w-64 h-64 sm:w-96 sm:h-96 bg-white/3 rounded-full blur-3xl" />
        <div className="absolute bottom-1/4 right-1/4 w-64 h-64 sm:w-80 sm:h-80 bg-white/3 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl sm:text-3xl font-black text-white">Smart Mobile Hub</h1>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-6 sm:p-8">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 bg-white/5 border border-white/10 rounded-2xl text-white placeholder:text-white/20 text-sm outline-none focus:border-white/30 focus:bg-white/10 transition-all"
                />
              </div>
            </div>
          ...
          <p className="text-sm text-white/40 mt-4 leading-relaxed">
            In development, use <span className="font-semibold text-white">admin@smartmobilehub.com</span> / <span className="font-semibold text-white">admin123</span> if the database is unavailable.
          </p>
        </div>
